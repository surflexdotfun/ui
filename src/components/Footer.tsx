  ...
  return (
    <div className="inline-block">
      <img
        ref={imgRef}
        onLoad={handleLoad}
        src={`/swog${index + 1}.png`}
        alt={`swog story ${index}`}
...
function FwogStoryBoard() {
  const story = [
    ...
    `"Wait… It's going up!?"`,
    `"From Swog to Financial Mogul."`,
  ];

  return (
    <div className="flex flex-col gap-9 items-center justify-center mt-9">
      <p className="text-[#54D2FF] text-16px">
        {"SWOG's Wild Ride: From Rags to Riches (and Back?)".toUpperCase()}
      </p>
  ...
  return (
    <footer className="w-full flex flex-col justify-center items-center pt-10">
      ...
      <div className="flex flex-col items-center my-9">
        <p className="text-white text-xs mb-2">© 2025 SurflexDotFun</p>

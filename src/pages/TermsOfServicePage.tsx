          ...
          <div className="border-[4px] border-white p-6 mb-8">
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                Welcome to SurflexDotFun. These Terms of Service govern your use
              ...
              <p className="mb-4 text-[10px]">
                ...
                our services. By using SurflexDotFun, you represent that you are
                at least 18 years old and capable of forming a binding contract.
              </p>
              <p className="mb-4 text-[10px]">
                These Terms constitute a legally binding agreement between you
                and SurflexDotFun regarding your use of our platform and services.
              </p>
            </div>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                SurflexDotFun provides a trading simulation platform. Our services
                are for educational and entertainment purposes only.
              </p>
              <p className="mb-4 text-[10px]">Our platform allows users to:</p>
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                To use certain features of our platform, you may need to create
                an account.
              </p>
              <p className="mb-4 text-[10px]">
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                ...
                <li>
                  Market data used in our simulations may differ from real-time
                  market data
                </li>
                <li>
                ...
                <li>
                  Any decisions made based on information from our platform are
                  at your own risk
                </li>
              </ul>
              <p className="mb-4 text-[10px]">
                SurflexDotFun is provided "as is" and "as available" without any
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                All content on SurflexDotFun is owned by us or our licensors and
              ...
              <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                <li>The SurflexDotFun name, logo, and branding</li>
              ...
              <p className="mb-4 text-[10px]">
                ...
                content from our platform for any commercial purpose without our
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                By using SurflexDotFun, you consent to our collection, use, and
            ...
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                SurflexDotFun and its affiliates will not be liable for any
                indirect, incidental, special, consequential or punitive
                damages.
              </p>
              <p className="mb-4 text-[10px]">
                To the maximum extent permitted by law, in no event shall
                SurflexDotFun, its directors, employees, partners, agents,
              ...
              <p className="mb-4 text-[10px]">
                ...
                based on breach of contract, tort (including negligence), or any
            ...
            <div>
              ...
              <p className="mb-4 text-[10px]">
                ...
                will be effective immediately upon posting on our website. We
              ...
              <p className="mb-4 text-[10px]">
                Your continued use of our platform after changes to these Terms

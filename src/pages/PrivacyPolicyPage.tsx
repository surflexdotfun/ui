          ...
          <div className="border-[4px] border-white p-6 mb-8">
            <div className="mb-8">
              ...
              <p className="mb-4 text-[10px]">
                At SurflexDotFun, we collect certain information to provide and
            ...
            <div className="mb-8">
              ...
              <ul className="list-disc pl-8 mb-4 space-y-2 text-[10px]">
                ...
                <li>
                  ...
                  to protect the rights, property, or safety of SurflexDotFun, our
                  users, or others.
                </li>
                <li>
            ...
            <div>
              ...
              <p className="mb-4 text-[10px]">
                ...
                contact us at support@surflexdotfun.com.
              </p>
